...
def _prompt(target_file: str, engine: str) -> str:
    ...
    return (
        ...
        'Evidence JSON contains long single-line records: do not scan evidence.json with '
        'grep or the read tool. Use pwsh.exe ConvertFrom-Json commands to select only the '
        'named evidence properties needed for the five criteria. '
