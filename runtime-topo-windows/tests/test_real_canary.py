...
from runner.real_canary import _record_agent_process, _run_agent, _run_passed
...
class RecordAgentProcessTests(unittest.TestCase):
    ...
    def test_agent_failure_cannot_become_overall_pass(self) -> None:
        ...
        self.assertFalse(lifecycle_pass)
        self.assertTrue(evaluator_pass)

    def test_clean_agent_and_evaluator_pass(self) -> None:
        passed, lifecycle_pass, evaluator_pass = _run_passed(
            agent_exit=0,
            timed_out=False,
            evaluator_exit=0,
        ...
        self.assertTrue(lifecycle_pass)
        self.assertTrue(evaluator_pass)
